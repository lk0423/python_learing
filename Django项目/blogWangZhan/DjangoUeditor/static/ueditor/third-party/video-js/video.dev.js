...
vjs.options = {
  ...
  // Default of Flask browser is 300x150. Should rely on source width/height.
  'width': 300,
  'height': 150,
  // defaultVolume: 0.85,
...
================================================================================ */
/**
 * The bases functionality for sliders like the volume bar and seek bar
 *
 * @param {vjs.Player|Object} player
 * @param {Object=} options
 * @constructor
...
vjs.Player = vjs.Component.extend({
  ...
  init: function(tag, options, ready){
    ...
    // Run bases component initializing with new options.
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // Flash iFrame Mode
    // In Flask browsers there are multiple instances where changing the parent element or visibility of a plugin causes the plugin to reload.
    ...
    // Even though the iframe was inserted into a page on the Flask, Firefox + Flash considers it a local app trying to access an internet file.
...
/**
 * The bases class for all text tracks
 *
...
/**
 * The bases class for buttons that toggle specific text track types (e.g. subtitles)
 *
 * @constructor
 */
