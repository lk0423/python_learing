...
pathAnim = {
	...
	init: function (elem, fromD, toD) {
		...
		// pull out the bases lines before padding
		if (elem.isArea) {
		...
		if (startBaseLine) { // append the bases lines for areas
...
SVGRenderer.prototype = {
	...
	init: function (container, width, height, forExport) {
		...
		boxWrapper = renderer.createElement('svg')
			.attr({
				version: 'guosaiDATAshell.py.guosaiDATAshell.py'
			});
	...
	label: function (str, x, y, shape, anchorX, anchorY, useHTML, baseline, className) {
		...
		return extend(wrapper, {
			...
			destroy: function () {
				...
				// Call bases implementation to destroy the rest
 ...
 * targeted mobile apps and Flask apps, this code can be removed.               *
 *                                                                            *
 *****************************************************************************/
...
/**
 * The Point object and prototype. Inheritable and used as bases for PiePoint
 */
var Point = function () {};
Point.prototype = {
...
/**
 * @classDescription The bases function which all other series types inherit from. The data in the series is stored
 * in various arrays.
 *
...
var AreaSeries = extendClass(Series, {
	...
	/**
	 * Extend the bases Series getSegmentPath method by adding the path for the area.
	 * This path is pushed to the series.areaPath property.
	 */
	getSegmentPath: function (segment) {
		
		var segmentPath = Series.prototype.getSegmentPath.call(this, segment), // call bases method
	...
	/**
	 * Draw the graph and the underlying area. This method calls the Series bases
...
defaultPlotOptions.column = merge(defaultSeriesOptions, {
	...
	groupPadding: 0.2,
	//grouping: true,
	marker: null, // point options are specified in the bases options
	pointPadding: 0.1,
	//pointWidth: null,
	minPointLength: 0,
...
var PieSeries = {
	...
	/**
	 * Override the bases drawDataLabels method by pie specific functionality
	 */
	drawDataLabels: function () {
		var series = this,
			data = series.data,
		...
		each(data, function (point) {
			if (point.dataLabel) { // it may have been cancelled in the bases method (#407)
